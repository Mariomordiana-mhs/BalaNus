...
<head>
    ...
    <style>
        /* Mengatur background senada dengan dashboard */
        body { 
        ...
        /* Tombol melengkung dengan warna biru khas dashboard */
        .btn-primary { 
        ...
        /* CSS BARU: Tombol Edit dan Hapus */
        .btn-edit { 
            background: #ffc107; 
            color: #000; 
            padding: 6px 12px; 
        ...
        /* Desain Tabel Bersih (Clean Table) */
        table { 
            width: 100%; 
        ...
        /* Mempercantik tampilan gambar cover */
        .cover-img {
            width: 45px;
            height: 65px;
            object-fit: cover;
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><?= $i++ ?></td>
                <td>
                    <img src="<?= base_url('uploads/covers/' . esc($b['cover'])) ?>" class="cover-img" alt="Cover">
                </td>
                <td><?= esc($b['isbn']) ?></td>
